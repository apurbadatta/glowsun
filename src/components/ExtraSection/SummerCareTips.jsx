  ...
  const tips = [
    {
      ...
      title: "Stay Hydrated",
      description:
        "Drink at least 8-10 glasses of water daily to keep your skin glowing and body energized under the heat.",
    ...
    },
    {
      ...
      description:
        "Always apply SPF 30+ sunscreen 20 minutes before heading out. Reapply every 2 hours for best results.",
    ...
    },
    {
      ...
      description:
        "Choose light-colored, loose cotton or linen clothes to allow air circulation and sweat evaporation.",
    ...
    },
    {
      ...
      description:
        "Incorporate seasonal fruits like watermelon and cucumber to maintain your body's natural cooling system.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto text-lg">
            Keep your summer fun and healthy with our simple yet effective daily
            care routine.
          </p>
        </div>
        ...
        <div className="mt-16 bg-slate-900 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            <h4 className="text-white text-2xl md:text-3xl font-bold mb-2">
              Want more summer secrets?
            </h4>
            <p className="text-slate-400">
              Join our newsletter for weekly tips and exclusive discounts.
            </p>
          </div>
